...
# Set the font for rendering the result
FONT = cv2.FONT_HERSHEY_SIMPLEX

# Load the neuron weights for judging the gender from the img
NEURON_WEIGHTS = cp.load("NeuronWeights.npy")
...
def main():
    ...
    while 1:
        ...
        Result = cv2.putText(Frame[1], "MAN" if JudgeGender(Frame[1]) else "WOMAN", (0, 0), FONT, 1, "White", 2, cv2.LINE_AA)
